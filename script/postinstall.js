...
if (!ADBLOCK && !CI && !SILENT) {
  log('\u001B[96m🙌  Thank you for using image2D (\u001B[94m https://github.com/yelloxing/image2D \u001B[96m) for Drawing Two-Dimensional Pictures!\u001B[0m\n');
  ...
  log('\u001B[96m🚨  Also, the author of image2D (\u001B[94m https://yelloxing.github.io/notebook/ \u001B[96m) is looking for a good time -)\u001B[0m\n');
}
