<template>
    <div>
        <header ref='header' id='topHeader'>
            <h2>image2D</h2>
            <ul>
                <li onclick='window.location.href="#/guide/"' id='guide'>开始</li>
                <li onclick='window.location.href="#/api/"' id='api'>文档</li>
                <li>
                    <a href="https://yelloxing.github.io/Image-Demo/index.html" target="_blank">例子</a>
                </li>
                <li onclick='window.location.href="#/about/"' id='about'>关于</li>
                <li>
                    <a href="https://github.com/yelloxing/image2D/issues" target="_blank">帮助</a>
                </li>
            </ul>
            <a href="https://github.com/yelloxing/image2D" class="github" target="_blank">Fork me on Github
            </a>
        </header>
        <section>
...
<script>
    ...
    export default {
        methods: {
            ...
            openEdit(){
                window.location.href="https://github.com/yelloxing/image2D/edit/dev/docs/src/pages/"+(window.location.href.split('#')[1]).replace(/\/$/,'')+".vue";
            }
        },
        mounted() {
